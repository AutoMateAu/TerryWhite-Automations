...
export default function NewDischargeDrawer({ isOpen, onClose, hospitals }: NewDischargeDrawerProps) {
  ...
  return (
    <Sheet open={isOpen} onOpenChange={onClose}>
      <SheetContent className="w-full sm:max-w-2xl flex flex-col p-0 shadow-lg ring-1 ring-purple-100">
        <SheetHeader className="p-6 pb-4 border-b border-gray-200">
          <SheetTitle className="text-2xl font-bold text-gray-900 border-l-4 border-purple-600 pl-4">
              ...
              <Button
                ...
                className={
                  selectedTemplateType === "admission"
                    ? "bg-purple-50 text-purple-600 border border-purple-600 shadow-sm hover:bg-purple-100"
                    : ""
                }
              >
          ...
          <div className="space-y-2 bg-purple-50 p-4 rounded-lg">
            ...
            <RadioGroup value={patientType} onValueChange={setPatientType} className="flex space-x-4">
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="new" id="patient-type-new" className="data-[state=checked]:text-purple-600" />
              ...
              <div className="flex items-center space-x-2">
                <RadioGroupItem
                  ...
                  className="data-[state=checked]:text-purple-600"
                />
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
              {hospitals
                ...
                .map((hospital) => (
                  ...
                  >
                    {hospital.name.replace(/ Private Hospital| Hospital/g, "")}
                  </Button>
                ))}
              <Button
        ...
        <SheetFooter className="p-6 pt-4 border-t border-gray-200 flex justify-end">
          <Button onClick={handleProceedToForm} className="bg-purple-500 text-white hover:bg-purple-600">
            Proceed to Form
          </Button>
        </SheetFooter>
      </SheetContent>
