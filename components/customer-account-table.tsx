  ...
  return (
    <div className="bg-bg-card rounded-lg shadow-sm border border-border-card p-6">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 space-y-4 md:space-y-0">
        <h2 className="text-xl font-bold text-text-dark border-l-4 border-purple-600 pl-2">Customer Accounts</h2>
        <div className="flex space-x-2 w-full md:w-auto">
          ...
          <Button
            variant="outline"
            className="border border-purple-600 text-purple-600 text-sm px-3 py-1.5 hover:bg-purple-50"
          >
          ...
          >
            <FileDown className="h-4 w-4 mr-2 text-purple-600" />
            Export
          </Button>
        </div>
      </div>
          ...
          <TableBody>
            {sortedAccounts.length > 0 ? (
              sortedAccounts.map((account) => (
                <TableRow
                  key={account.id}
                  className="border-b border-border-card last:border-b-0 transition hover:bg-purple-50 cursor-default"
                >
