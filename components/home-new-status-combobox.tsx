...
const statuses = [
  { value: "home", label: "Home Med" },
  { value: "new", label: "New Med" },
]

interface HomeNewStatusComboboxProps {
  value: string
  onChange: (value: string) => void
}

export function HomeNewStatusCombobox({ value, onChange }: HomeNewStatusComboboxProps) {
